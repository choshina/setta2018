...
\begin{tabular}{l|l}
\hline
 CDRS & \textbf{C}ritical \textbf{D}ara \textbf{R}ace \textbf{S}equence \\
 HLDR & \textbf{H}igh \textbf{L}evel \textbf{D}ata \textbf{R}ace \\
 CAS & \textbf{C}ompare \textbf{A}nd \textbf{S}wap \\
 FGVT & \textbf{F}ine-\textbf{G}rained \textbf{V}eri\textbf{T}race \\
\hline
\end{tabular}}
\end{table}
...
\begin{itemize}
  ...
  \item We develop a labeled \textit{interleaving tree} model that contains all the possible fine-grained traces of a concurrent execution. Each node is labeled automatically in a way that can reflect the existence of a CDRS through certain pattern.
